...
func TestGoString(t *testing.T) {
	...
	f.WriteString("\t\"time\"\n")
	f.WriteString("\textra \"awalterschulze.org/go/goderive/test/extra\"\n")
	f.WriteString("\ttest \"awalterschulze.org/go/goderive/test/normal\"\n")
	f.WriteString("\tpickle \"awalterschulze.org/go/goderive/test/nickname\"\n")
	f.WriteString(")\n")
	f.WriteString("\n")
