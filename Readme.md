...
Tool Functions:
  ...
  - [Intersect](http://godoc.org/github.com/awalterschulze/goderive/plugin/intersect) `deriveIntersect([]T, []T) []T` or `deriveIntersect(map[T]struct{}, map[T]struct{}) map[T]struct{}`
