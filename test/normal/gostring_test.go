...
func TestGoString(t *testing.T) {
	...
	f.WriteString("\t\"time\"\n")
	f.WriteString("\textra \"github.com/ndeloof/goderive/test/extra\"\n")
	f.WriteString("\ttest \"github.com/ndeloof/goderive/test/normal\"\n")
	f.WriteString("\tpickle \"github.com/ndeloof/goderive/test/nickname\"\n")
	f.WriteString(")\n")
	f.WriteString("\n")
